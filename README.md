# Разбор внутренней пустоты

Тест на тип внутренней пустоты: экзистенциальная, эмоциональная или энергетическая. Полный разбор, нумерология числа судьбы и план наполнения на 30 дней.
...
- Return URL: `https://inner-emptiness.vercel.app/thank-you`
- Webhook URL: `https://inner-emptiness.vercel.app/api/webhook` — события `payment.succeeded` и `payment.canceled`
